...
public class BookToBookStore extends TableImpl<BookToBookStoreRecord> {
	...
	private static final long serialVersionUID = -472702187;
	 ...
	 */
	public final TableField<BookToBookStoreRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false), this, "");
