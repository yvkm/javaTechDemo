...
public class BookStore extends TableImpl<BookStoreRecord> {
	...
	private static final long serialVersionUID = -271272501;
	 ...
	 */
	public final TableField<BookStoreRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false), this, "");
